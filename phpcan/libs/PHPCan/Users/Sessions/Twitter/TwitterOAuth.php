...
namespace PHPCan\Users\Sessions\Twitter;

defined('ANS') or die();

include (filePath('phpcan/libs|PHPCan/Users/Sessions/Twitter/Oauth_consumer.php'));
...
class TwitterOAuth
{
  ...
  function getXAuthToken($username, $password)
  {
    ...
    $token = OAuthUtil::parse_parameters($request);
    $this->token = new \PHPCan\Users\Sessions\Twitter\Oauth_consumer($token['oauth_token'], $token['oauth_token_secret']);
